            ...
            <div className="row align-items-center justify-content-center">
              <div className="col-md-7 py-5">
                ...
                <Form>
                  ...
                  {teamCount === 2 &&
                  < div class="mt-5 mb-5">  <h2> Team Details</h2>
                       <div class="row">
                       <div class="col-md-6 mb-3">
                         <div class="form-group first">
                           <label htmlFor="teamMembers.member_1">Member 1 Name</label>
                           <Field
                       ...
                       <div class="form-group col-lg-6 mb-3">
                         <label htmlFor="email.member_1">Member 1 Email</label>
                         <Field
                           id="email"
                           name="email.member_1"
                       ...
                       <div class=" mb-3">
                         <div class="form-group first">
                           <label htmlFor="phone">Member 1 whatsApp Number</label>
                           <Field
                             id="phone"
                     ...
                     <div class="row">
                       ...
                       <div class="col-md-6 mb-3">
                         <div class="form-group first">
                           <label htmlFor="teamMembers.member_2">Member 2 Name</label>
                           <Field
                       ...
                       <div class="form-group col-lg-6 mb-3">
                         <label htmlFor="email.member_2">Member 2 Email</label>
                         <Field
                           id="email"
                           name="email.member_2"
                           placeholder="sample@gmail.com"
                       ...
                       <div class=" mb-3">
                         <div class="form-group first">
                           <label htmlFor="phone">Member 2 whatsApp Number</label>
                           <Field
                             id="phone"
                     ...
                     {teamCount === 3 &&
                      ...
                      <div class="row">
                       ...
                       <div class="col-md-6 mb-3">
                         <div class="form-group first">
                           <label htmlFor="teamMembers.member_3">Member 3 Name</label>
                           <Field
                       ...
                       <div class="form-group col-lg-6 mb-3">
                         <label htmlFor="email.member_3">Member 3 Email</label>
                         <Field
                           id="email"
                           name="email.member_3"
                           placeholder="sample@gmail.com"
                       ...
                       <div class=" mb-3">
                         <div class="form-group first">
                           <label htmlFor="phone">Member 3 whatsApp Number</label>
                           <Field
                             id="phone"
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 mb-3">
                        <div class="form-group first">
                          <label htmlFor="teamMembers.member_4">Member 4 Name</label>
                          <Field
                      ...
                      <div class="form-group col-lg-6 mb-3">
                        <label htmlFor="email.member_4">Member 4 Email</label>
                        <Field
                          id="email"
                          name="email.member_4"
                          placeholder="sample@gmail.com"
                      ...
                      <div class=" mb-3">
                        <div class="form-group first">
                          <label htmlFor="phone">Member 4 whatsApp Number</label>
                          <Field
                            id="phone"
